...
class FastenHEATConv(MessagePassing):
    ...
    def __init__(self, in_channels: int, out_channels: int,
                 ...
                 root_weight: bool = True, bias: bool = True, engine: Engine = Engine.AUTO, **kwargs):
    ...
    def forward(self, x: Tensor, edge_index: Adj, node_type: Tensor,
                edge_type: Tensor, edge_attr: OptTensor = None, tensor_slice_hl: TensorSlice = None) -> Tensor:

        x = self.hetero_lin(x, node_type, tensor_slice_hl)
