...
OSE_GVCS2 = read_slices_from_csv('datasets_csv/OSE_GVCS2.csv')
MovieLens1M2 = read_slices_from_csv('datasets_csv/MovieLens1M2.csv')
IGMCD_Douban2 = read_slices_from_csv('datasets_csv/IGMCD_Douban2.csv')
Freebase1 = read_slices_from_csv('datasets_csv/Freebase1.csv')
IGMCD_Flixster1 = read_slices_from_csv('datasets_csv/IGMCD_Flixster1.csv')
IGMCD_Douban1 = read_slices_from_csv('datasets_csv/IGMCD_Douban1.csv')
IMDB1 = read_slices_from_csv('datasets_csv/IMDB1.csv')
IGMCD_YahooMusic1 = read_slices_from_csv('datasets_csv/IGMCD_YahooMusic1.csv')
ACM1 = read_slices_from_csv('datasets_csv/ACM1.csv')
AmazonBook2 = read_slices_from_csv('datasets_csv/AmazonBook2.csv')
DBLP1 = read_slices_from_csv('datasets_csv/DBLP1.csv')
Taobao1 = read_slices_from_csv('datasets_csv/Taobao1.csv')
LastFM1 = read_slices_from_csv('datasets_csv/LastFM1.csv')
OSE_GVCS1 = read_slices_from_csv('datasets_csv/OSE_GVCS1.csv')
ACM2 = read_slices_from_csv('datasets_csv/ACM2.csv')
LastFM2 = read_slices_from_csv('datasets_csv/LastFM2.csv')
IGMCD_Flixster2 = read_slices_from_csv('datasets_csv/IGMCD_Flixster2.csv')
AMiner2 = read_slices_from_csv('datasets_csv/AMiner2.csv')
Taobao2 = read_slices_from_csv('datasets_csv/Taobao2.csv')
IGMCD_YahooMusic2 = read_slices_from_csv('datasets_csv/IGMCD_YahooMusic2.csv')
Freebase2 = read_slices_from_csv('datasets_csv/Freebase2.csv')
DBLP2 = read_slices_from_csv('datasets_csv/DBLP2.csv')
MovieLens1 = read_slices_from_csv('datasets_csv/MovieLens1.csv')
AMiner1 = read_slices_from_csv('datasets_csv/AMiner1.csv')
AmazonBook1 = read_slices_from_csv('datasets_csv/AmazonBook1.csv')
...
def test_segment_matmul(K: int, slices: list, engine: Engine, device: str, phase: str, dtype: str) -> None:
    ...
    if phase == "forward":
        ...
        if M // T >= 2048:
            ...
            torch.testing.assert_close(other.grad, other_grad_ref, atol=1.0, rtol=1e-1)
        else:
